...
impl Ray {
    ...
    /// ```
    pub const UP: Self = Self { origin: Vec2::ZERO, direction: Vec2 { x: 0., y: 1. } };
    ...
    /// ```
    /// 
    pub const RIGHT: Self = Self { origin: Vec2::ZERO, direction: Vec2 { x: 1., y: 0. } };
    ...
    /// assert_eq!(ray1.direction(), ray2.direction());
    /// ```
    pub const DOWN: Self = Self { origin: Vec2::ZERO, direction: Vec2 { x: 0., y: -1. } };
    ...
    /// assert_eq!(ray1.direction(), ray2.direction());
    /// ```
    pub const LEFT: Self = Self { origin: Vec2::ZERO, direction: Vec2 { x: -1., y: 0. } };
}
